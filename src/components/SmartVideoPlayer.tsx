...
export default function SmartVideoPlayer({ video, isActive, onTrailerEnd, globalMuted, setGlobalMuted }: SmartVideoPlayerProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 right-16 px-6 pt-6 pb-0 flex flex-col justify-end pointer-events-none z-20 transition-all duration-200 bottom-[24px] group-hover:bottom-[100px]">
      ...
      >
        ...
        <div className="flex items-center justify-between">
           ...
           {/* Right Controls Pill */}
           <div className="flex items-center bg-black/50 backdrop-blur-md rounded-full p-[4px] gap-[0px] text-white mr-2">
